        ...
        <tbody>
          <tr v-for="user in filteredUsers" :key="user.id">
            ...
            <td>
              ...
              <small>{{ user.exp_points }} XP</small>
            </td>
    ...
    <div class="rwd-modal-overlay" v-if="selectedUser" @click.self="closeModal">
      <div class="rwd-modal">
        ...
        <div class="rwd-actions">
          <button class="rwd-submit" @click="giveReward">Submit</button>
...
export default {
  data() {
    return {
      ...
      users: [
        { id: 1, username: "john_doe", email: "john@email.com", level: 3, exp_points: 120 },
        { id: 2, username: "anna_fit", email: "anna@email.com", level: 5, exp_points: 260 },
        { id: 3, username: "mark_strong", email: "mark@email.com", level: 2, exp_points: 80 },
        { id: 4, username: "lisa_cardio", email: "lisa@email.com", level: 6, exp_points: 400 },
      ]
    }
  },
  ...
  methods: {
    ...
    giveReward() {
      ...
      // APPLY REWARD
      this.selectedUser.exp_points += this.form.exp

      while (this.selectedUser.exp_points >= this.selectedUser.level * 100) {
        this.selectedUser.exp_points -= this.selectedUser.level * 100
        this.selectedUser.level++
      }

      // TODO: Send to backend using this format:
      // achievements: {
      //   title,
      //   description,
      //   exp_gained
      ...
      this.showToast("Reward granted successfully 🎉")
      this.closeModal()
    },
